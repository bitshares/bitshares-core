...
**NOTE:** The official GRE git repository location, default branch, and submodule remotes were recently changed. Existing
repositories can be updated with the following steps:

    git remote set-url origin https://github.com/gre-foundation/gre-core.git
    git checkout master
...
[wiki](https://github.com/gre-foundation/gre-core/wiki).
...
To build after all dependencies are installed:
    ...
    git clone https://github.com/gre-foundation/gre-core.git
    cd gre-core
...
**NOTE:** GRE requires an [OpenSSL](https://www.openssl.org/) version in the 1.0.x series. OpenSSL 1.1.0 and newer are NOT supported. If your system OpenSSL version is newer, then you will need to manually provide an older version of OpenSSL and specify it to CMake using `-DOPENSSL_INCLUDE_DIR`, `-DOPENSSL_SSL_LIBRARY`, and `-DOPENSSL_CRYPTO_LIBRARY`.

**NOTE:** GRE requires a [Boost](http://www.boost.org/) version in the range [1.57, 1.63]. Versions earlier than
...
[here](https://github.com/gre-foundation/gre-core/blob/master/libraries/wallet/include/graphene/wallet/wallet.hpp).
...
GRE Core bugs can be reported directly to the [issue tracker](https://github.com/gre-foundation/gre-core/issues).

<!-- BitShares UI bugs should be reported to the [UI issue tracker](https://github.com/gre-foundation/gre-ui/issues) -->
...
- What is the meaning of `a.b.c` numbers?
    ...
    [types.hpp](https://github.com/gre-foundation/gre-core/blob/master/libraries/chain/include/graphene/chain/protocol/types.hpp).
...
License
-------
GRE Core is under the MIT license. See [LICENSE](https://github.com/gre-foundation/gre-core/blob/master/LICENSE.txt)
