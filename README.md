...
Information for developers can be found in the [Bitshares Developer Portal](http://dev.bitshares.works/). Users interested in how bitshares works can go the [BitShares Documentation](http://how.bitshares.works/) site.
